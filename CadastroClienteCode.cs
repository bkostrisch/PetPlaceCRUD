...
namespace MVPetPlace
{
    public partial class CadastroClientes : Form
    {
        ...
        {
            string txtQuery = "insert into cadastro (ID, Nome, Celular, Email, Endereco, RG, CPF, NomPet, Raca, Idade, Sexo, Servico)values('" + txtIdCliente.Text + "','" + txtNomeCliente.Text + "','" + txtCelularCliente.Text + "','" + txtEmailCliente.Text + "', '" + txtEndCliente.Text + "', '" + txtRgCliente.Text + "', '" + txtCpfCliente.Text + "','" + txtNomePet.Text + "','" + txtRacaPet.Text + "','" + txtIdadePet.Text + "','" + txtSexoPet.Text + "','" + txtServico.Text + "')";
        ...
        {
            string txtQuery = "update cadastro set (Nome, Celular, Email, Endereco, RG, CPF, NomPet, Raca, Idade, Sexo, Servico)=('" + txtNomeCliente.Text + "','" + txtCelularCliente.Text + "','" + txtEmailCliente.Text + "', '" + txtEndCliente.Text + "', '" + txtRgCliente.Text + "', '" + txtCpfCliente.Text + "','" + txtNomePet.Text + "','" + txtRacaPet.Text + "','" + txtIdadePet.Text + "','" + txtSexoPet.Text + "','" + txtServico.Text + "') where ID = '" + txtIdCliente.Text + "'";
            ExecuteQuery(txtQuery);
            LoadData();
            txtIdCliente.Text = string.Empty;
            txtNomeCliente.Text = string.Empty;
